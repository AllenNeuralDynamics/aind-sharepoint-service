...
class NSB2023LimsTaskflow(str, Enum):
    ...
    BRAIN_OBSERVATORY_VISUAL_BEHAVIOR_1B = 'Brain Observatory Visual NSB2023Behavior 1B'
    BRAIN_OBSERVATORY_VISUAL_BEHAVIOR_NEUROPIXEL = 'Brain Observatory Visual NSB2023Behavior Neuropixel'
    ...
    MSP_DYNAMIC_ROUTING_BEHAVIOR_DEVELOPMENT = 'MSP Dynamic Routing NSB2023Behavior Development'
    ...
    MSP_DYNAMIC_ROUTING_ULTRA_OPTOTAGGING_BEHAVIOR = 'MSP Dynamic Routing Ultra Optotagging NSB2023Behavior'

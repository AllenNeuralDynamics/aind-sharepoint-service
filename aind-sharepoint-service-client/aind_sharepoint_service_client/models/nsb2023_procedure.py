...
class NSB2023Procedure(str, Enum):
    ...
    SX_21__INJECTION__FIBER = 'Sx-21 Injection + Fiber Optic Implant (with NSB2023Headpost)'
    ...
    INJ_DHC = 'INJ+DHC'
    INJECTION_FIBER_OPTIC_IMP_ = 'Injection + Fiber Optic Implant (with NSB2023Headpost)'

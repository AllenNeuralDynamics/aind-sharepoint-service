# AindSharepointServiceServerModelsNsb2023Limstaskflow
...
* `EPHYS_TASK_DEV_DYANMIC_ROUTING_LEFT_PARENTHESIS_NSB_BEH_RIGHT_PARENTHESIS` (value: `'Ephys Task Dev Dyanmic Routing (NSB Beh)'`)

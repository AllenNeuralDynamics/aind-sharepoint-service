...
REST service to retrieve data from Sharepoint.
...
- Run `docker build -t aind-sharepoint-service-server-local:latest .`
- Run `docker run -p 58350:58350 -p 5000:80 --env-file=env/webapp.env aind-sharepoint-service-server-local:latest`
